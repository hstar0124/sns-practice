...
public class PostControllerTest {
    ...
    void 포스트_작성시_로그인_하지않은_경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 포스트_수정시_로그인_하지않은_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 포스트_수정시_작성자가_아닌_경우_에러_발생() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 포스트_삭제시_로그인하지_않는경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 포스트_삭제시_작성자가_아닌_경우() throws Exception {
